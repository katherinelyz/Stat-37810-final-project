...
```{r algorithm}
betametropolis <- function(startvalue, c, thin=10, burnin=1000, iterations=10000){
...
The Beta Meteropolis-Hastings alogrithm is defined as a function which starts with number of iteration of 0's called the *chain*. The default set *thin* = 10, *burnin* = 1,000, and *iterations* = 10,000
...
draws <- betametropolis(startvalue, 1, 10, 1000, 10000)
```
...
for (i in 1:length(cvec)){
  par(mfrow=c(1, 3))
  draws=betametropolis(startvalue, cvec[i], 10, 1000, 10000)
